...
const memberData = [
    ...
    { name: "นายปัญญาพัฒน์ นรการ", role: "รองประธานนักเรียน", quote: "ช่วยงานและทำหน้าที่แทนประธานเมื่อไม่อยู่ \n ควบคุมและติดตามงานแต่ละฝ่าย \n ช่วยแก้ปัญหาและตัดสินใจร่วมกับประธาน", img: "images/breet.jpg" },
    ...
    { name: "น.ส.ปฐมาวดี เกษแก้ว", role: "ปฏิคม", quote: "ต้อนรับแขกและผู้เข้าร่วมกิจกรรม \n ดูแลความสะดวกเรียบร้อยในงานต่างๆ \n ช่วยจัดสถานที่และดูแลบรรยากาศงาน", img: "images/pluem.jpg" }
];
